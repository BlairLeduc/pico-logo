...
rested on is 60 µs against an assumed 35. **M1 — the game, rocks only — is
written and green on the host** (`logo/games/asteroids`, 23 tests) and waiting
on its board run, which is the gate on M2.
