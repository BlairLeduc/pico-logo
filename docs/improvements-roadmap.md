...
| HTTP server (`http.listen`, `when [http.request?]`, `http.respond`, file transfer) | todo | Design done (gate closed 2026-07-10), implementation not started: [P7](#p7--http-server-design-complete-implementation-not-started). Scope added 2026-07-12: mDNS (`picologo.local`) + `wifi.hostname`/`wifi.sethostname`, folded into the design as §7/M0 |
