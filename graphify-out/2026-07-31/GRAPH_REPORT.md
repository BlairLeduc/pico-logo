# Graph Report - pico-logo  (2026-07-29)

## Corpus Check
- 285 files · ~472,913 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6968 nodes · 22080 edges · 203 communities (192 shown, 11 thin omitted)
...
Cohesion: 0.02
Nodes (239): MockLine, MockDeviceState, mock_device_get_line(), mock_device_get_output(), mock_device_get_state(), mock_device_has_line_from_to(), mock_device_line_count(), test_reset_restores_defaults() (+231 more)
...
Cohesion: 0.02
Nodes (165): format_number(), Evaluator, Result, Value, prim_date(), prim_setdate(), prim_settime(), prim_ticks() (+157 more)

### Community 4 - "mem_is_nil"
Cohesion: 0.05
Nodes (124): mem_car(), mem_cdr(), mem_is_nil(), mem_is_word(), Lexer, parse_list_body(), parse_list_from_string(), Evaluator (+116 more)
...
Cohesion: 0.02
Nodes (141): Value, value_is_true(), mem_is_blob(), mem_word_ptr(), test_make_small_number_in_object_is_valid_json(), test_make_small_number_is_valid_json(), test_apply_with_word_primitive(), test_filter_with_word() (+133 more)
...
Cohesion: 0.11
Nodes (95): number_to_word(), mem_gc_roots_pop(), mem_gc_roots_push(), mem_list_append(), mem_word_len(), Evaluator, Result, Value (+87 more)
...
Cohesion: 0.04
Nodes (43): test_deep_recursion_100_levels(), test_deep_recursion_addupto(), test_deep_recursion_factorial(), test_deep_recursion_nested_in_expression(), test_deep_recursion_print_result(), test_error_in_nested_procedure_includes_innermost_proc_name(), test_error_infix_doesnt_like(), test_error_paren_mismatch() (+35 more)
...
Cohesion: 0.03
Nodes (159): demons_maybe_poll(), eval_instruction(), httpd_maybe_poll(), prim_editfile(), Evaluator, Result, Value, prim_load() (+151 more)
...
Cohesion: 0.07
Nodes (60): frame_stack_is_empty(), Value, find_global(), var_bury(), var_bury_all(), var_declare_local(), var_erase(), var_erase_all() (+52 more)

### Community 20 - "test_token_source.c"
Cohesion: 0.47
Nodes (9): Evaluator, Result, Value, prim_copydef(), prim_define(), prim_definedp(), prim_primitivep(), prim_text() (+1 more)
...
Cohesion: 0.07
Nodes (65): httpd_listening(), httpd_request_pending(), httpd_reset(), mock_httpd_conn_response(), mock_httpd_is_listening(), mock_httpd_listen_port(), mock_httpd_queue_connection(), mock_httpd_queue_connection_ex() (+57 more)
...
### Community 25 - "io.c"
Cohesion: 0.05
Nodes (57): LogoIO, primitives_control_reset_test_state(), primitives_set_io(), properties_init(), repl_line_is_end(), repl_line_starts_with_to(), LogoConsole, LogoHardware (+49 more)
...
Cohesion: 0.04
Nodes (52): tearDown(), tearDown(), tearDown(), tearDown(), tearDown(), tearDown(), tearDown(), drain() (+44 more)
...
Cohesion: 0.08
Nodes (37): Node, Result, demons_clear(), demons_freeze(), demons_print(), demons_reset(), demons_running(), demons_set() (+29 more)
...
Cohesion: 0.09
Nodes (59): LogoHardwareOps, Result, Value, check_response_headers(), ci_eq(), close_conn(), header_find(), httpd_body() (+51 more)
...
Cohesion: 0.13
Nodes (41): fat32_close(), fat32_create(), fat32_delete(), fat32_is_mounted(), fat32_mount(), fat32_open(), fat32_set_current_dir(), fat32_unmount() (+33 more)
...
Cohesion: 0.09
Nodes (44): BlobDesc, demons_gc_mark_all(), Value, mark_value(), op_stack_gc_mark(), alloc_cell(), atom_chain_next(), atom_clear_marks() (+36 more)
...
Cohesion: 0.15
Nodes (25): fat32_get_cluster_size(), fat32_get_generation(), fat32_read(), fat32_seek(), fat32_size(), LogoStream, file_context_stale(), logo_picocalc_dir_create() (+17 more)

### Community 76 - "prim_savel"
Cohesion: 0.03
Nodes (87): proc_define_from_text(), test_deep_nested_proc_in_repeat(), test_many_iterations_proc_in_repeat_within_procedure(), test_proc_call_followed_by_commands_in_repeat(), test_proc_call_in_if_within_procedure(), test_proc_call_in_repeat_within_procedure(), test_proc_expr_in_run_within_procedure(), test_co_at_toplevel() (+79 more)
...
Cohesion: 0.12
Nodes (53): UserProcedure, frame_current(), frame_find_binding(), frame_get_bindings(), frame_has_pending_continuation(), frame_push(), frame_reuse(), frame_save_continuation() (+45 more)
...
Cohesion: 0.09
Nodes (38): LogoConsole, mock_device_dot_count(), mock_device_get_console(), mock_device_has_dot_at(), mock_device_verify_heading(), mock_device_verify_position(), reset_mock_storage(), setUp() (+30 more)
...
Cohesion: 0.06
Nodes (111): mem_atom(), mem_cons(), Lexer, Node, Token, TokenType, classify_word(), is_comment_node() (+103 more)
...
Cohesion: 0.15
Nodes (23): frame_binding_count(), frame_stack_available_bytes(), frame_stack_depth(), frame_stack_used_bytes(), FrameStack, proc_get_frame_stack(), var_get_local_by_index(), var_local_count() (+15 more)
...
Cohesion: 0.05
Nodes (86): httpd_buf_init(), blob_alloc(), Node, mem_atom_unescape(), mem_blob(), mem_blob_free_bytes(), mem_blob_used(), mem_free_atoms() (+78 more)

### Community 112 - "southbridge.c"
Cohesion: 0.11
Nodes (51): Evaluator, LogoIO, Node, Result, UserProcedure, Value, help_list_add(), help_list_flush() (+43 more)
...
Cohesion: 0.13
Nodes (53): mem_atom_cstr(), Evaluator, Result, Value, prim_allopen(), prim_close(), prim_closeall(), prim_dribble() (+45 more)
...
Cohesion: 0.23
Nodes (18): test_local_variable_not_visible_after_scope(), test_local_variable_shadowing(), test_localmake_declares_and_sets(), test_localmake_shadows_global(), test_make_creates_global_when_no_local(), test_make_updates_local_in_scope(), test_nested_scopes(), test_scope_push_pop() (+10 more)
...
Cohesion: 0.15
Nodes (14): LogoHardware, LogoHardwareOps, logo_hardware_init(), LogoConsole, logo_host_console_create(), logo_host_console_destroy(), LogoHardware, logo_host_hardware_create() (+6 more)
...
Cohesion: 0.33
Nodes (9): mem_set_cdr(), Node, proc_define(), test_set_cdr(), test_deep_non_tail_recursion_limit(), test_deep_tail_recursion(), test_recursive_procedure(), test_tail_recursive_countdown() (+1 more)
...
### Community 161 - "Open"
Cohesion: 0.17
Nodes (12): B1 — Multi-line `(…)` expressions inside a procedure body evaluate to empty, B2 — Single-line `to … end` definitions are not supported, B3 — Demons fire during `load`, B4 — `parse_list` silently drops unknown tokens, B5 — `name_buf[64]` identifier truncation aliasing, B6 — `penreverse` ignores pen size (always 1 px), B7 — A user-procedure call as the left operand of a parenthesised expression corrupts the parse, B8 — A turtle command automatically switches to splitscreen (+4 more)
...
## Knowledge Gaps
- **730 isolated node(s):** `dist.sh script`, `flash.sh script`, `name`, `displayName`, `description` (+725 more)
...
- **Why does `eval_string()` connect `eval_string` to `run_string`, `mem_is_nil`, `reset_output`, `mem_word_ptr`, `repl_line_starts_with_to`, `value_to_string`, `mem_atom`, `error_format`, `format_buffer_init`, `lexer_init`, `test_httpd.c`, `test_io.c`, `test_primitives_http.c`, `test_primitives_json.c`, `test_primitives_control_flow.c`, `httpd_listening`, `test_scaffold.h`, `test_primitives_wifi.c`, `test_primitives_hardware.c`, `test_scaffold_setUp`, `test_primitives_outside_world.c`, `httpd.c`, `test_mock_device.c`, `test_primitives_outside_world.c`, `test_primitives_network.c`, `test_mock_fs.h`, `op_stack_push`, `prim_savel`, `eval.c`, `test_scaffold.c`, `frame_stack_depth`, `The pick of five: plans`, `test_galaxian.c`, `logo_io_init`, `eval_primary`, `southbridge.c`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **Why does `run_string()` connect `run_string` to `eval_string`, `mem_is_nil`, `reset_output`, `mem_word_ptr`, `repl_line_starts_with_to`, `result_none`, `mem_atom`, `error_format`, `format_buffer_init`, `lexer_init`, `test_primitives_editor.c`, `primitives_wifi.c`, `test_variables.c`, `output_has`, `test_io.c`, `io.c`, `httpd_listening`, `mock_device_get_state`, `test_primitives_json.c`, `test_primitives_control_flow.c`, `httpd_listening`, `test_scaffold.h`, `test_primitives_hardware.c`, `test_scaffold_setUp`, `set_mock_input`, `test_primitives_outside_world.c`, `httpd.c`, `test_mock_device.c`, `test_primitives_outside_world.c`, `demons_poll`, `op_stack_push`, `test_primitives_editor.c`, `prim_savel`, `eval.c`, `test_scaffold.c`, `frame_stack_depth`, `The pick of five: plans`, `test_galaxian.c`, `logo_io_init`, `eval_primary`, `southbridge.c`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **Why does `mem_word_ptr()` connect `mem_word_ptr` to `run_string`, `eval_string`, `test_value.c`, `mem_is_nil`, `prim_savel`, `reset_output`, `result_none`, `value_to_string`, `repl_line_starts_with_to`, `error_format`, `format_buffer_init`, `test_primitives_editor.c`, `test_token_source.c`, `test_httpd.c`, `test_primitives_http.c`, `httpd_listening`, `test_scaffold.h`, `test_primitives_conditionals.c`, `memory.c`, `test_primitives_wifi.c`, `test_primitives_hardware.c`, `mem_atom_cstr`, `test_scaffold_setUp`, `set_mock_input`, `test_primitives_outside_world.c`, `httpd.c`, `test_mock_device.c`, `test_primitives_outside_world.c`, `test_primitives_network.c`, `test_primitives_files_directory.c`, `primitives_json.c`, `test_primitives_editor.c`, `step_proc_call`, `prim_savel`, `eval_push_if`, `The pick of five: plans`, `primitives_http.c`, `mklfsimg_lib.c`, `logo_storage_init`, `southbridge.c`, `test_primitives_properties.c`, `logo_io_init`?**
