...
## Corpus Check
- 282 files · ~451,132 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6803 nodes · 21591 edges · 192 communities (188 shown, 4 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 9710 edges (avg confidence: 0.8)
...
## Communities (192 total, 4 thin omitted)

### Community 0 - "run_string"
Cohesion: 0.02
Nodes (208): MockLine, mock_device_clear_graphics(), mock_device_get_line(), mock_device_get_output(), mock_device_has_line_from_to(), mock_device_line_count(), test_turtle_draw_line_when_pen_down(), test_turtle_no_line_when_pen_up() (+200 more)
...
Cohesion: 0.02
Nodes (179): test_abs_decimal(), test_abs_negative(), test_abs_positive(), test_abs_zero(), test_arctan(), test_arctan_too_many_inputs(), test_arctan_two_input(), test_arctan_two_input_vertical() (+171 more)

### Community 3 - "test_value.c"
Cohesion: 0.03
Nodes (176): Node, demons_set(), format_number(), mem_atom(), json_format_number(), Node, Result, Value (+168 more)

### Community 4 - "mem_is_nil"
Cohesion: 0.03
Nodes (183): mem_atom_unescape(), mem_blob(), mem_blob_free_bytes(), mem_blob_used(), mem_car(), mem_cdr(), mem_free_atoms(), mem_free_nodes() (+175 more)

### Community 5 - "reset_output"
Cohesion: 0.02
Nodes (166): proc_is_stepped(), proc_is_traced(), test_comment_in_procedure(), test_comment_inline(), test_comment_with_list(), test_comment_with_word(), test_do_until_basic(), test_do_until_invalid_predicate() (+158 more)

### Community 6 - "mem_word_ptr"
Cohesion: 0.02
Nodes (148): mem_word_ptr(), test_readchar_from_file(), test_setread_to_file(), test_setreadpos(), test_setwrite_to_file(), test_write_and_read_file(), test_apply_with_word_primitive(), test_filter_with_word() (+140 more)

### Community 7 - "result_none"
Cohesion: 0.08
Nodes (114): Value, demons_clear(), demons_freeze(), demons_frozen(), demons_print(), demons_reset(), demons_running(), demons_thaw() (+106 more)

### Community 8 - "value_to_string"
Cohesion: 0.13
Nodes (80): number_to_word(), mem_gc_roots_pop(), mem_gc_roots_push(), mem_list_append(), mem_word_len(), Evaluator, Result, Value (+72 more)

### Community 9 - "mem_atom"
Cohesion: 0.09
Nodes (37): LogoConsole, mock_device_dot_count(), mock_device_get_console(), mock_device_has_dot_at(), mock_device_reset(), mock_device_verify_heading(), mock_device_verify_position(), test_background_colour() (+29 more)

### Community 10 - "test_frame.c"
Cohesion: 0.08
Nodes (55): UserProcedure, calc_frame_size(), frame_get_bindings(), frame_get_test(), frame_iterate(), frame_pop(), frame_push(), frame_reuse() (+47 more)
...
Cohesion: 0.06
Nodes (93): Node, UserProcedure, Value, format_body_element(), format_body_element_multiline(), format_buffer_init(), format_buffer_output(), format_buffer_pos() (+85 more)
...
Cohesion: 0.09
Nodes (52): Value, find_global(), var_bury(), var_bury_all(), var_declare_local(), var_erase(), var_erase_all(), var_erase_all_globals() (+44 more)
...
Cohesion: 0.08
Nodes (71): eval_instruction(), httpd_maybe_poll(), prim_editfile(), LogoIO, LogoStream, SyntaxCategory, create_network_stream(), highlight_write_span() (+63 more)
...
### Community 25 - "io.c"
Cohesion: 0.07
Nodes (35): primitives_control_reset_test_state(), properties_init(), mock_device_init(), setUp(), setUp(), setUp(), setUp(), setUp() (+27 more)
...
Cohesion: 0.04
Nodes (74): MockCommand, MockDeviceState, mock_device_clear_commands(), mock_device_command_count(), mock_device_get_command(), mock_device_get_state(), mock_device_last_command(), assert_fullscreen_canvas_hud() (+66 more)

### Community 29 - "mock_device.c"
Cohesion: 0.02
Nodes (66): MockCommandType, MockDot, LogoEditorResult, LogoPen, LogoStream, LogoTurtleRaster, SoundEvent, SoundStatus (+58 more)
...
Cohesion: 0.13
Nodes (18): Evaluator, Result, Value, prim_catch(), prim_error(), prim_throw(), prim_toplevel(), Evaluator (+10 more)
...
Cohesion: 0.07
Nodes (36): LogoIO, primitives_set_io(), procedures_init(), main(), LogoStorage, logo_host_storage_create(), logo_host_storage_destroy(), LogoConsole (+28 more)
...
Cohesion: 0.12
Nodes (37): LogoHardwareOps, Result, Value, check_response_headers(), ci_eq(), close_conn(), header_find(), httpd_body() (+29 more)
...
Cohesion: 0.06
Nodes (31): 10. Art, palette, and shape budget, 11. Sound, 12. State machine and frame order, 13. Memory and performance, 14. Tests, 15. Implementation milestones, 1. Product goals and boundaries, 2. Full-screen composition (+23 more)
...
Cohesion: 0.14
Nodes (29): Result, demons_maybe_poll(), demons_poll(), MockTurtleState, mock_device_clear_output(), mock_device_get_turtle(), test_action_does_not_reenter_poll(), test_cleardemons_disarms_all() (+21 more)
...
Cohesion: 0.10
Nodes (55): EvalOpKind, Evaluator, FrameStack, Lexer, Node, Result, UserProcedure, Value (+47 more)
...
### Community 71 - "main"
Cohesion: 0.19
Nodes (14): find_procedure_index(), proc_bury(), proc_bury_all(), proc_clear_tail_call(), proc_push_current(), proc_restore_execution_state(), proc_save_execution_state(), proc_step() (+6 more)
...
Cohesion: 0.04
Nodes (58): logo_io_flush(), logo_io_is_dribbling(), logo_io_parse_network_address(), logo_io_set_reader(), logo_io_set_writer(), logo_io_start_dribble(), logo_io_stop_dribble(), LogoDirCallback (+50 more)
...
Cohesion: 0.03
Nodes (93): proc_define_from_text(), test_deep_nested_proc_in_repeat(), test_proc_call_followed_by_commands_in_repeat(), test_proc_call_in_if_within_procedure(), test_proc_expr_in_run_within_procedure(), test_co_at_toplevel(), test_freeze_request_break_stops_execution(), test_freeze_request_waits_for_key() (+85 more)
...
Cohesion: 0.12
Nodes (45): Binding, FrameHeader, FrameStack, Value, word_offset_t, frame_add_local(), frame_at(), frame_at_depth() (+37 more)
...
Cohesion: 0.23
Nodes (32): eval_trampoline(), op_stack_pop(), EvalOp, EvalOpKind, Evaluator, Node, Result, UserProcedure (+24 more)
...
Cohesion: 0.10
Nodes (21): Node, Result, Value, result_get_error_code(), result_get_goto_label(), result_get_pause_proc(), result_get_throw_tag(), result_get_value() (+13 more)
...
Cohesion: 0.22
Nodes (24): Evaluator, Result, Value, prim_load(), prim_loadpic(), prim_pofile(), prim_save(), prim_savel() (+16 more)
...
Cohesion: 0.20
Nodes (22): Lexer, parse_list_body(), parse_list_from_string(), Evaluator, Result, Value, flush_writer(), prim_keyp() (+14 more)
...
Cohesion: 0.16
Nodes (25): eval_at_end(), apply_binary_op(), Evaluator, Node, Result, TokenType, Value, eval_expr_bp() (+17 more)

### Community 114 - "primitives_outside_world.c"
Cohesion: 0.12
Nodes (34): frame_stack_depth(), FrameStack, proc_get_frame_stack(), var_get_local_by_index(), var_get_test(), var_local_count(), var_reset_test_state(), var_set_test() (+26 more)
...
### Community 133 - "repl_evaluate_line"
Cohesion: 0.31
...
### Community 151 - "logo_hardware_init"
Cohesion: 0.22
...
### Community 162 - "primitives_variables.c"
Cohesion: 0.53
...
Cohesion: 0.08
Nodes (72): mem_atom_cstr(), Evaluator, Result, Value, prim_abs(), prim_arctan(), prim_cos(), prim_difference() (+64 more)
...
### Community 170 - "logo_stream_init"
Cohesion: 0.40
...
Cohesion: 0.27
Nodes (18): frame_push_value(), frame_value_count(), Evaluator, Result, Value, prim_ashift(), prim_bitand(), prim_bitnot() (+10 more)

### Community 180 - "procedures.c"
Cohesion: 0.06
Nodes (64): BlobDesc, demons_gc_mark_all(), Value, mark_value(), op_stack_gc_mark(), alloc_cell(), atom_chain_next(), atom_clear_marks() (+56 more)
...
## Knowledge Gaps
- **688 isolated node(s):** `dist.sh script`, `flash.sh script`, `name`, `displayName`, `description` (+683 more)
...
- **Why does `run_string()` connect `run_string` to `eval_string`, `prim_pause`, `mem_is_nil`, `reset_output`, `mem_word_ptr`, `result_none`, `error_format`, `format_buffer_init`, `lexer_init`, `test_primitives_editor.c`, `test_token_source.c`, `test_io.c`, `logo_hardware_init`, `mock_device_get_state`, `test_primitives_json.c`, `test_primitives_control_flow.c`, `test_scaffold.h`, `test_primitives_files.c`, `test_primitives_hardware.c`, `test_time.c`, `set_mock_input`, `test_primitives_outside_world.c`, `procedures.c`, `test_mock_device.c`, `demons_poll`, `op_stack_push`, `prim_savel`, `repl_evaluate_line`, `test_scaffold.c`, `test_galaxian.c`, `logo_storage_init`, `primitives_control_flow.c`, `primitives_outside_world.c`, `test_primitives_properties.c`, `logo_io_init`, `eval_primary`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `eval_string()` connect `eval_string` to `run_string`, `test_value.c`, `mem_is_nil`, `reset_output`, `mem_word_ptr`, `value_to_string`, `error_format`, `format_buffer_init`, `lexer_init`, `test_token_source.c`, `test_httpd.c`, `test_primitives_http.c`, `mock_device_get_state`, `test_primitives_json.c`, `test_primitives_control_flow.c`, `test_scaffold.h`, `test_primitives_files.c`, `repl_line_starts_with_to`, `test_primitives_wifi.c`, `test_primitives_hardware.c`, `test_time.c`, `test_primitives_outside_world.c`, `procedures.c`, `test_mock_device.c`, `test_primitives_network.c`, `test_mock_fs.h`, `op_stack_push`, `prim_savel`, `eval_push_if`, `test_scaffold.c`, `test_galaxian.c`, `logo_storage_init`, `primitives_control_flow.c`, `primitives_outside_world.c`, `test_primitives_properties.c`, `eval_primary`, `frame_stack_is_empty`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `mem_word_ptr()` connect `mem_word_ptr` to `run_string`, `eval_string`, `test_value.c`, `mem_is_nil`, `reset_output`, `result_none`, `value_to_string`, `primitives_properties.c`, `proc_define_from_text`, `error_format`, `format_buffer_init`, `test_primitives_editor.c`, `test_token_source.c`, `test_httpd.c`, `test_io.c`, `test_primitives_http.c`, `primitives_debug_control.c`, `test_primitives_json.c`, `primitives_variables.c`, `repl_line_starts_with_to`, `test_primitives_wifi.c`, `test_primitives_hardware.c`, `mem_atom_cstr`, `test_time.c`, `set_mock_input`, `test_primitives_outside_world.c`, `httpd.c`, `procedures.c`, `test_mock_device.c`, `test_primitives_network.c`, `test_primitives_files_directory.c`, `primitives_json.c`, `value_number`, `prim_savel`, `primitives_httpd.c`, `eval_push_if`, `ensure_wifi_initialized`, `mklfsimg_lib.c`, `logo_storage_init`, `southbridge.c`, `primitives_control_flow.c`, `primitives_outside_world.c`, `frame_stack_is_empty`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Are the 908 inferred relationships involving `run_string()` (e.g. with `load_checkrun()` and `run()`) actually correct?**
  _`run_string()` has 908 INFERRED edges - model-reasoned connections that need verification._
- **Are the 892 inferred relationships involving `eval_string()` (e.g. with `number()` and `truth()`) actually correct?**
