...
## Corpus Check
- 285 files · ~476,019 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7002 nodes · 22197 edges · 206 communities (193 shown, 13 thin omitted)
- Extraction: 56% EXTRACTED · 44% INFERRED · 0% AMBIGUOUS · INFERRED: 9824 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ef56fe53`
...
1. `run_string()` - 935 edges
2. `eval_string()` - 901 edges
...
Cohesion: 0.02
Nodes (170): Node, demons_print(), demons_set(), format_number(), prim_when(), prim_settime(), Node, Result (+162 more)

### Community 4 - "mem_is_nil"
Cohesion: 0.06
Nodes (116): mem_car(), mem_cdr(), mem_gc_roots_pop(), mem_gc_roots_push(), mem_is_list(), mem_is_nil(), mem_is_word(), parse_list_from_string() (+108 more)

### Community 5 - "reset_output"
Cohesion: 0.02
Nodes (185): proc_is_stepped(), proc_is_traced(), test_rerandom_affects_pick_and_shuffle(), test_comment_in_procedure(), test_comment_inline(), test_comment_with_list(), test_comment_with_word(), test_do_until_basic() (+177 more)

### Community 6 - "mem_word_ptr"
Cohesion: 0.02
Nodes (138): mem_word_ptr(), test_make_small_number_in_object_is_valid_json(), test_make_small_number_is_valid_json(), test_apply_with_word_primitive(), test_filter_with_word(), test_find_basic(), test_find_first_element(), test_find_with_word() (+130 more)
...
Cohesion: 0.14
Nodes (73): number_to_word(), mem_list_append(), mem_word_len(), prim_form(), prim_readchars(), Evaluator, Node, Result (+65 more)
...
### Community 11 - "io.c"
Cohesion: 0.07
Nodes (79): eval_instruction(), LogoIO, LogoStream, SyntaxCategory, create_network_stream(), highlight_write_span(), logo_io_check_freeze_request(), logo_io_check_pause_request() (+71 more)
...
Cohesion: 0.06
Nodes (47): picocalc_editor_get_ops(), keyboard_set_idle_callback(), LogoConsole, LogoPen, LogoRotationStyle, LogoTurtleRaster, ScreenSprite, heading_faces_left() (+39 more)

### Community 14 - "format_buffer_init"
Cohesion: 0.05
Nodes (113): Node, UserProcedure, Value, format_body_element(), format_body_element_multiline(), format_body_indent(), format_buffer_init(), format_buffer_output() (+105 more)
...
Cohesion: 0.04
Nodes (51): logo_io_cleanup(), logo_io_parse_network_address(), logo_io_resolve_path(), logo_io_set_prefix(), normalize_path(), LogoDirCallback, LogoEntryType, LogoStream (+43 more)
...
Cohesion: 0.06
Nodes (86): frame_stack_used_bytes(), FrameStack, proc_get_frame_stack(), Value, find_global(), var_bury(), var_bury_all(), var_declare_local() (+78 more)
...
Cohesion: 0.03
Nodes (94): CaughtError, append_caller_suffix(), Result, error_clear_caught(), error_format(), error_get_caught(), error_message(), error_set_caught() (+86 more)
...
Cohesion: 0.05
Nodes (67): logo_mem_init(), LogoIO, primitives_control_reset_test_state(), primitives_set_io(), procedures_init(), properties_init(), variables_init(), LogoHardware (+59 more)
...
Cohesion: 0.03
Nodes (67): tearDown(), tearDown(), tearDown(), tearDown(), tearDown(), assert_fullscreen_canvas_hud(), assert_hud_write_positions(), load_game() (+59 more)
...
Cohesion: 0.07
Nodes (28): repeating_timer_t, keyboard_get_key(), keyboard_init(), keyboard_key_available(), keyboard_peek_key(), keyboard_poll(), keyboard_set_background_poll(), keyboard_set_key_available_callback() (+20 more)

### Community 36 - "mem_atom_cstr"
Cohesion: 0.13
Nodes (38): mem_atom_cstr(), Evaluator, Result, Value, prim_catch(), prim_error(), prim_throw(), prim_toplevel() (+30 more)
...
Cohesion: 0.17
Nodes (35): CatalogContext, CatalogEntry, Evaluator, LogoEntryType, LogoIO, Result, Value, catalog_callback() (+27 more)
...
Cohesion: 0.08
Nodes (74): proc_reset_execution_state(), LogoIO, Result, repl_cleanup(), repl_count_bracket_balance(), repl_evaluate_line(), repl_extract_proc_name(), repl_find_end_token() (+66 more)
...
Cohesion: 0.08
Nodes (49): Value, demons_clear(), demons_frozen(), demons_maybe_poll(), demons_reset(), demons_resume(), demons_running(), demons_suspend() (+41 more)

### Community 52 - "stream.c"
Cohesion: 0.10
Nodes (36): logo_io_copy_file(), LogoStream, screen_gfx_save(), LogoStream, LogoStreamOps, logo_stream_can_read(), logo_stream_clear_write_error(), logo_stream_close() (+28 more)
...
### Community 54 - ";"
Cohesion: 0.05
Nodes (37): ;, and, Appendix C: Useful Procedures, Appendix D: Error Messages, Appendix E: Colour Palette for Pico Logo, battery, .bootsel, Break (+29 more)
...
Cohesion: 0.11
Nodes (42): BlobDesc, demons_gc_mark_all(), Value, mark_value(), op_stack_gc_mark(), alloc_cell(), atom_chain_next(), atom_clear_marks() (+34 more)
...
Cohesion: 0.12
Nodes (32): Result, demons_poll(), MockTurtleState, mock_device_clear_output(), mock_device_get_turtle(), setUp(), tearDown(), test_action_does_not_reenter_poll() (+24 more)

### Community 67 - "test_dirty_tiles.c"
Cohesion: 0.15
Nodes (26): dirty_tiles_any(), dirty_tiles_clear(), dirty_tiles_mark_all(), dirty_tiles_mark_rect(), dirty_tiles_mark_rect_wrap(), dirty_tiles_next_span(), wrap_coord(), screen_gfx_mark_dirty() (+18 more)
...
Cohesion: 0.09
Nodes (29): text_get_background(), text_get_foreground(), text_set_background(), turtle_canvas_point(), turtle_dot(), turtle_draw_text(), turtle_fill(), ScreenSprite (+21 more)
...
Cohesion: 0.03
Nodes (101): append_to_list(), Lexer, Node, Token, parse_bracket_contents(), proc_define_from_text(), token_to_atom(), test_deep_nested_proc_in_repeat() (+93 more)
...
Cohesion: 0.08
Nodes (65): UserProcedure, frame_current(), frame_get_bindings(), frame_get_test(), frame_has_pending_continuation(), frame_pop(), frame_push(), frame_reuse() (+57 more)
...
Cohesion: 0.03
Nodes (108): MockCommand, LogoConsole, MockDeviceState, mock_device_clear_commands(), mock_device_command_count(), mock_device_dot_count(), mock_device_get_command(), mock_device_get_console() (+100 more)

### Community 89 - "screen_set_mode"
Cohesion: 0.09
Nodes (30): lcd_restore_palette(), lcd_set_background(), lcd_set_palette_rgb(), lcd_set_palette_value(), LogoStream, error_output_flush(), error_output_write(), input_read_char() (+22 more)
...
Cohesion: 0.10
Nodes (69): Lexer, Node, Token, classify_word(), is_comment_node(), is_number_word(), token_source_at_end(), token_source_consume_sublist() (+61 more)
...
### Community 109 - "test_primitives_files_directory.c"
Cohesion: 0.06
...
Cohesion: 0.27
Nodes (19): Evaluator, Result, Value, flush_writer(), prim_keyp(), prim_print(), prim_readchar(), prim_readlist() (+11 more)

### Community 111 - "mem_atom"
Cohesion: 0.06
Nodes (81): mem_atom(), mem_atom_unescape(), mem_free_atoms(), mem_free_nodes(), mem_gc(), mem_total_atoms(), mem_word_eq(), setUp() (+73 more)
...
Cohesion: 0.16
Nodes (17): UserProcedure, find_procedure_index(), find_procedure_index_n(), proc_bury(), proc_bury_all(), proc_clear_tail_call(), proc_find_n(), proc_push_current() (+9 more)
...
Cohesion: 0.09
Nodes (21): Build and test, Code structure, Constraints, Graphify, Project, Unit testing, Working guidelines, Build & Test (+13 more)
...
Cohesion: 0.14
Nodes (21): blob_alloc(), blob_reset(), logo_mem_set_aux_region(), mem_blob(), mem_blob_free_bytes(), mem_blob_used(), mem_region_alloc(), mem_words_equal() (+13 more)

### Community 132 - "mem_cons"
Cohesion: 0.08
Nodes (38): mem_cons(), mem_set_cdr(), Node, proc_define(), value_extract_rgb(), value_extract_xy(), Node, exhaust_node_pool() (+30 more)
...
Cohesion: 0.21
Nodes (16): Evaluator, Result, Value, pause_check_continue(), pause_request_continue(), pause_reset_state(), prim_co(), prim_go() (+8 more)
...
### Community 147 - "test_fileserver.c"
Cohesion: 0.19
...
Cohesion: 0.12
Nodes (42): Binding, FrameHeader, FrameStack, Value, word_offset_t, calc_frame_size(), frame_add_local(), frame_at() (+34 more)
...
### Community 173 - "primitives_files.c"
Cohesion: 0.31
...
### Community 176 - "httpd_request_pending"
Cohesion: 0.24
...
Cohesion: 0.25
Nodes (11): Lexer, parse_list_body(), Evaluator, Result, Value, prim_copydef(), prim_define(), prim_definedp() (+3 more)

### Community 196 - "southbridge.c"
Cohesion: 0.32
...
### Community 198 - "test_httpd_device.c"
Cohesion: 0.20
Nodes (10): mock_httpd_queue_connection_ex(), mock_httpd_queue_connection_stalled(), drain(), setUp(), tearDown(), test_accept_returns_connection_and_remote_ip(), test_can_read_reflects_available_bytes(), test_dribbled_read_delivers_in_chunks() (+2 more)

### Community 199 - "format.h"
Cohesion: 0.31
Nodes (9): Evaluator, Result, Value, prim_battery_level(), prim_bootsel(), prim_goodbye(), prim_toot(), toot_gate_freq() (+1 more)

### Community 200 - "httpd_listening"
Cohesion: 0.26
...
### Community 201 - "prim_setdate"
Cohesion: 0.50
Nodes (8): Evaluator, Result, Value, prim_date(), prim_setdate(), prim_ticks(), prim_time(), valid_date()
...
## Knowledge Gaps
- **723 isolated node(s):** `dist.sh script`, `flash.sh script`, `name`, `displayName`, `description` (+718 more)
...
- **Why does `run_string()` connect `run_string` to `eval_string`, `test_value.c`, `mem_is_nil`, `reset_output`, `mem_cons`, `mem_word_ptr`, `result_none`, `test_trails.c`, `io.c`, `test_primitives_files_load_save.c`, `format_buffer_init`, `lexer_init`, `test_variables.c`, `error_format`, `test_scaffold_setUp`, `primitives_httpd.c`, `test_primitives_json.c`, `test_primitives_conditionals.c`, `test_scaffold.h`, `test_primitives_files.c`, `test_time.c`, `set_mock_input`, `test_primitives_outside_world.c`, `test_primitives_hardware.c`, `test_primitives_variables.c`, `eval_primary`, `test_sound.c`, `eval.c`, `demons_poll`, `op_stack_push`, `test_primitives_editor.c`, `proc_define_from_text`, `mock_device_get_state`, `test_primitives_files_directory.c`, `test_galaxian.c`, `test_scaffold.c`, `test_checkrun.c`?**
  _High betweenness centrality (0.136) - this node is a cross-community bridge._
- **Why does `eval_string()` connect `eval_string` to `test_value.c`, `mem_is_nil`, `reset_output`, `mem_word_ptr`, `mem_cons`, `value_to_string`, `test_trails.c`, `format_buffer_init`, `lexer_init`, `test_fileserver.c`, `test_variables.c`, `test_httpd.c`, `error_format`, `test_primitives_http.c`, `primitives_httpd.c`, `test_primitives_json.c`, `test_primitives_conditionals.c`, `test_scaffold.h`, `test_primitives_wifi.c`, `test_primitives_files.c`, `test_time.c`, `test_primitives_outside_world.c`, `httpd_request_pending`, `test_primitives_hardware.c`, `test_primitives_variables.c`, `eval_primary`, `test_sound.c`, `test_primitives_network.c`, `eval.c`, `demons_poll`, `op_stack_push`, `httpd_listening`, `proc_define_from_text`, `mock_device_get_state`, `test_primitives_files_directory.c`, `test_galaxian.c`, `test_scaffold.c`, `test_checkrun.c`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `mem_word_ptr()` connect `mem_word_ptr` to `run_string`, `eval_string`, `mem_blob`, `mem_is_nil`, `test_value.c`, `reset_output`, `primitives_debug_control.c`, `result_none`, `value_to_string`, `mem_cons`, `format_buffer_init`, `test_variables.c`, `primitives_sound.c`, `test_httpd.c`, `error_format`, `test_primitives_http.c`, `properties.c`, `primitives_httpd.c`, `mem_atom_cstr`, `test_primitives_wifi.c`, `test_primitives_files.c`, `primitives_get_io`, `step_proc_call`, `test_time.c`, `primitives_files.c`, `set_mock_input`, `test_primitives_outside_world.c`, `httpd_request_pending`, `test_primitives_hardware.c`, `httpd.c`, `test_primitives_variables.c`, `eval_primary`, `test_sound.c`, `test_primitives_network.c`, `memory.c`, `primitives_json.c`, `prim_define`, `test_primitives_editor.c`, `proc_define_from_text`, `prim_savel`, `test_token_source.c`, `primitives_control_flow.c`, `test_primitives_files_directory.c`, `primitives_outside_world.c`, `mem_atom`, `primitives_workspace.c`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Are the 933 inferred relationships involving `run_string()` (e.g. with `load_checkrun()` and `run()`) actually correct?**
  _`run_string()` has 933 INFERRED edges - model-reasoned connections that need verification._
- **Are the 899 inferred relationships involving `eval_string()` (e.g. with `num()` and `truth()`) actually correct?**
  _`eval_string()` has 899 INFERRED edges - model-reasoned connections that need verification._
