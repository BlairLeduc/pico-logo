...
## Corpus Check
- 274 files · ~428,880 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6562 nodes · 20966 edges · 191 communities (182 shown, 9 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 9491 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f9e0b960`
...
Cohesion: 0.02
Nodes (172): format_number(), Evaluator, Result, Value, prim_date(), prim_setdate(), prim_settime(), prim_ticks() (+164 more)

### Community 4 - "mem_is_nil"
Cohesion: 0.04
Nodes (139): BlobDesc, blob_desc(), Node, index_to_node(), mem_car(), mem_cdr(), mem_is_list(), mem_is_nil() (+131 more)

### Community 5 - "reset_output"
Cohesion: 0.02
Nodes (187): primitive_find(), proc_is_stepped(), proc_is_traced(), test_rerandom_affects_pick_and_shuffle(), test_comment_in_procedure(), test_comment_inline(), test_comment_with_list(), test_comment_with_word() (+179 more)

### Community 6 - "mem_word_ptr"
Cohesion: 0.02
Nodes (128): Value, value_is_true(), mem_word_ptr(), test_make_small_number_in_object_is_valid_json(), test_make_small_number_is_valid_json(), test_apply_with_word_primitive(), test_filter_with_word(), test_find_basic() (+120 more)
...
Cohesion: 0.15
Nodes (75): number_to_word(), mem_list_append(), mem_word(), mem_word_len(), Evaluator, Result, Value, invoke_proc_spec() (+67 more)

### Community 9 - "mem_atom"
Cohesion: 0.05
Nodes (88): mem_atom(), mem_cons(), mem_free_atoms(), mem_free_nodes(), mem_gc(), mem_total_atoms(), value_extract_rgb(), value_extract_xy() (+80 more)

### Community 10 - "test_frame.c"
Cohesion: 0.08
Nodes (53): UserProcedure, word_offset_t, calc_frame_size(), frame_get_bindings(), frame_get_test(), frame_iterate(), frame_pop(), frame_push() (+45 more)

### Community 11 - "proc_define_from_text"
Cohesion: 0.03
Nodes (82): proc_define_from_text(), test_deep_nested_proc_in_repeat(), test_many_iterations_proc_in_repeat_within_procedure(), test_proc_call_followed_by_commands_in_repeat(), test_proc_call_in_if_within_procedure(), test_proc_call_in_repeat_within_procedure(), test_proc_expr_in_run_within_procedure(), test_co_at_toplevel() (+74 more)
...
Cohesion: 0.09
Nodes (62): value_number(), Value, find_global(), var_bury(), var_bury_all(), var_declare_local(), var_erase(), var_erase_all() (+54 more)

### Community 20 - "test_token_source.c"
Cohesion: 0.10
Nodes (67): Lexer, Node, Token, classify_word(), is_comment_node(), is_number_word(), token_source_at_end(), token_source_consume_sublist() (+59 more)
...
### Community 25 - "io.c"
Cohesion: 0.07
Nodes (88): eval_instruction(), httpd_savebody(), prim_editfile(), Evaluator, Result, Value, prim_load(), prim_loadpic() (+80 more)

### Community 26 - "test_primitives_http.c"
Cohesion: 0.05
Nodes (70): mock_device_get_last_tcp_ip(), mock_device_get_last_tcp_port(), mock_device_get_last_tls_host(), mock_device_get_tcp_request(), mock_device_get_tcp_request_len(), mock_device_set_tcp_close_after(), mock_device_set_tcp_connect_result(), mock_device_set_tcp_read_chunk() (+62 more)
...
Cohesion: 0.08
Nodes (36): demons_gc_mark_all(), alloc_cell(), atom_entry_next(), atom_entry_set_next(), atom_hash(), blob_free(), blob_reset(), find_atom() (+28 more)
...
Cohesion: 0.11
Nodes (52): Binding, FrameHeader, FrameStack, Value, frame_add_local(), frame_at(), frame_at_depth(), frame_binding_count() (+44 more)
...
Cohesion: 0.04
Nodes (83): Lexer, eval_init(), logo_mem_init(), LogoIO, primitives_control_reset_test_state(), primitives_set_io(), proc_clear_tail_call(), proc_reset_execution_state() (+75 more)
...
Cohesion: 0.05
Nodes (62): Node, demons_print(), demons_running(), demons_set(), Evaluator, Result, Value, pause_check_continue() (+54 more)
...
Cohesion: 0.10
Nodes (36): LogoStream, screen_gfx_load(), screen_gfx_save(), LogoStream, LogoStreamOps, logo_stream_can_read(), logo_stream_clear_write_error(), logo_stream_close() (+28 more)
...
Cohesion: 0.12
Nodes (47): primitive_get_by_index(), primitive_get_count(), Evaluator, LogoIO, Node, Result, UserProcedure, Value (+39 more)
...
Cohesion: 0.15
Nodes (39): eval_at_end(), advance(), get_infix_bp(), Evaluator, Token, TokenType, peek(), op_stack_pop() (+31 more)

### Community 58 - "picocalc_hardware.c"
Cohesion: 0.06
Nodes (24): cyw43_ev_scan_result_t, mbedtls_ms_time(), mdns_start(), mdns_stop(), ntp_dns_callback(), ntp_recv_callback(), ntp_send_request(), picocalc_dns_callback() (+16 more)
...
Cohesion: 0.08
Nodes (42): primitives_arithmetic_init(), primitives_bitwise_init(), primitives_conditionals_init(), primitives_control_flow_init(), primitives_debug_control_init(), primitives_debug_init(), primitives_editor_init(), primitives_events_init() (+34 more)
...
Cohesion: 0.14
Nodes (28): demons_frozen(), demons_poll(), MockTurtleState, mock_device_clear_output(), mock_device_get_turtle(), test_action_does_not_reenter_poll(), test_cleardemons_disarms_all(), test_cleardemons_leaves_motion_and_freeze() (+20 more)
...
Cohesion: 0.13
Nodes (24): frame_stack_depth(), frame_stack_used_bytes(), FrameStack, proc_get_frame_stack(), var_get_local_by_index(), var_is_shadowed_by_local(), var_local_count(), test_stack_init_empty() (+16 more)
...
Cohesion: 0.09
Nodes (73): mem_atom_cstr(), Evaluator, Result, Value, Evaluator, LogoEntryType, Result, Value (+65 more)
...
Cohesion: 0.28
Nodes (9): var_get_test(), var_reset_test_state(), var_set_test(), var_test_is_valid(), test_get_test_no_valid_test(), test_reset_test_state(), test_set_and_get_test_state(), test_test_is_valid_after_set() (+1 more)
...
Cohesion: 0.33
Nodes (12): apply_binary_op(), Evaluator, Node, Result, TokenType, Value, eval_expr_bp(), eval_expression() (+4 more)
...
Cohesion: 0.47
Nodes (6): Result, demons_maybe_poll(), httpd_maybe_poll(), logo_io_has_ticks_ms(), logo_io_ticks_ms(), console_idle_poll()
...
Cohesion: 0.23
Nodes (12): demons_clear(), demons_freeze(), demons_reset(), demons_thaw(), Evaluator, Result, Value, prim_cleardemons() (+4 more)
