...
## Corpus Check
- 293 files · ~513,175 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7225 nodes · 22948 edges · 208 communities (203 shown, 5 thin omitted)
- Extraction: 56% EXTRACTED · 44% INFERRED · 0% AMBIGUOUS · INFERRED: 10184 edges (avg confidence: 0.8)
...
## Communities (208 total, 5 thin omitted)

### Community 0 - "run_string"
Cohesion: 0.02
Nodes (196): MockLine, MockTurtleState, mock_device_get_line(), mock_device_get_output(), mock_device_get_turtle(), mock_device_has_line_from_to(), mock_device_line_count(), test_cleardemons_leaves_motion_and_freeze() (+188 more)
...
Cohesion: 0.05
Nodes (106): Node, mem_car(), mem_cdr(), mem_is_list(), mem_is_nil(), mem_set_car(), Lexer, parse_list_body() (+98 more)
...
Cohesion: 0.09
Nodes (71): mem_atom_unescape(), mem_first_cell(), mem_is_word(), mem_next_cell(), prim_for(), Evaluator, Result, Value (+63 more)
...
### Community 11 - "io.c"
Cohesion: 0.07
Nodes (75): eval_instruction(), LogoIO, LogoStream, create_network_stream(), logo_io_check_freeze_request(), logo_io_check_pause_request(), logo_io_check_user_interrupt(), logo_io_clear_freeze_request() (+67 more)
...
Cohesion: 0.05
Nodes (52): picocalc_editor_get_ops(), keyboard_set_idle_callback(), LogoConsole, LogoPen, LogoRotationStyle, LogoTurtleRaster, ScreenSprite, heading_faces_left() (+44 more)

### Community 14 - "format_buffer_init"
Cohesion: 0.11
Nodes (35): format_buffer_init(), format_buffer_output(), format_variable(), format_variable_to_buffer(), test_format_body_element_nested_list(), test_format_body_element_nil_produces_no_output(), test_format_body_element_simple_list(), test_format_body_element_word() (+27 more)
...
Cohesion: 0.06
Nodes (62): frame_at_depth(), Value, find_global(), var_bury(), var_bury_all(), var_declare_local(), var_erase(), var_erase_all() (+54 more)
...
Cohesion: 0.02
Nodes (106): CaughtError, append_caller_suffix(), Result, error_clear_caught(), error_format(), error_get_caught(), error_message(), error_set_caught() (+98 more)
...
Cohesion: 0.07
Nodes (34): LogoIO, primitives_control_reset_test_state(), primitives_set_io(), mock_device_init(), mock_device_reset(), setUp(), setUp(), load_fileserver() (+26 more)

### Community 26 - "test_primitives_http.c"
Cohesion: 0.06
Nodes (68): logo_mem_set_aux_region(), mock_device_get_last_tcp_ip(), mock_device_get_last_tcp_port(), mock_device_get_last_tls_host(), mock_device_get_tcp_request(), mock_device_set_tcp_connect_result(), mock_device_set_tcp_response(), Result (+60 more)
...
Cohesion: 0.02
Nodes (54): MockDot, LogoStream, LogoTurtleRaster, SoundEvent, SoundStatus, WifiState, mock_device_add_wifi_scan_result(), mock_device_get_dot() (+46 more)
...
Cohesion: 0.05
Nodes (84): mem_atom(), mem_blob(), mem_blob_free_bytes(), mem_blob_used(), mem_free_atoms(), mem_free_nodes(), mem_gc(), mem_is_blob() (+76 more)

### Community 32 - "test_scaffold.h"
Cohesion: 0.03
Nodes (71): tearDown(), tearDown(), tearDown(), tearDown(), tearDown(), tearDown(), assert_fullscreen_canvas_hud(), assert_hud_write_positions() (+63 more)
...
### Community 35 - "main"
Cohesion: 0.24
Nodes (10): LogoConsole, logo_host_console_create(), logo_host_console_destroy(), LogoHardware, logo_host_hardware_create(), logo_host_hardware_destroy(), main(), LogoStorage (+2 more)

### Community 36 - "test_primitives_files.c"
Cohesion: 0.04
Nodes (55): mock_fs_reset(), mock_fs_setUp(), mock_fs_tearDown(), setUp(), tearDown(), setUp(), tearDown(), setUp() (+47 more)
...
Cohesion: 0.40
Nodes (12): Evaluator, Result, Value, prim_false(), prim_if(), prim_ifelse(), prim_iffalse(), prim_iftrue() (+4 more)
...
### Community 42 - "primitives_httpd.c"
Cohesion: 0.32
...
Cohesion: 0.03
Nodes (107): MockCommand, LogoConsole, MockDeviceState, mock_device_clear_commands(), mock_device_command_count(), mock_device_dot_count(), mock_device_get_command(), mock_device_get_console() (+99 more)
...
Cohesion: 0.07
Nodes (59): demons_frozen(), LogoHardwareOps, Result, Value, check_response_headers(), ci_eq(), close_conn(), header_find() (+51 more)
...
Cohesion: 0.06
Nodes (50): var_exists(), mock_device_get_gfx_load_call_count(), mock_device_get_gfx_save_call_count(), mock_device_get_last_gfx_load_filename(), mock_device_get_last_gfx_save_filename(), mock_device_set_gfx_load_result(), mock_device_set_gfx_save_result(), setUp_with_turtle() (+42 more)
...
Cohesion: 0.10
Nodes (40): BlobDesc, remember_binding(), alloc_cell(), atom_chain_next(), atom_clear_marks(), atom_entry_is_free(), atom_entry_next(), atom_entry_set_next() (+32 more)

### Community 62 - "op_stack_push"
Cohesion: 0.13
Nodes (34): Lexer, eval_init(), EvalOp, Value, mark_value(), op_stack_alloc_prim_args(), op_stack_depth(), op_stack_gc_mark() (+26 more)
...
Cohesion: 0.14
Nodes (27): Result, demons_poll(), mock_device_clear_output(), test_action_does_not_reenter_poll(), test_cleardemons_disarms_all(), test_clearscreen_leaves_demons_armed(), test_clearscreen_stops_motion(), test_freeze_halts_motion() (+19 more)
...
### Community 70 - "define_proc"
Cohesion: 0.05
Nodes (51): proc_is_stepped(), proc_is_traced(), setUp(), tearDown(), test_step_and_trace_independent(), test_step_multiline_procedure(), test_step_nonexistent_gives_error(), test_step_pauses_execution() (+43 more)

### Community 71 - "primitives.h"
Cohesion: 0.06
Nodes (60): Node, demons_clear(), demons_freeze(), demons_gc_mark_all(), demons_print(), demons_reset(), demons_resume(), demons_set() (+52 more)
...
Cohesion: 0.05
Nodes (50): keyboard_get_key(), keyboard_init(), keyboard_key_available(), keyboard_peek_key(), keyboard_set_background_poll(), keyboard_set_key_available_callback(), lcd_get_palette_value(), lcd_set_palette_value() (+42 more)
...
Cohesion: 0.05
Nodes (75): proc_define_from_text(), FrameStack, proc_get_frame_stack(), test_b9_multiline_literal_counts_as_data(), test_b9_multiline_literal_iterates_as_data(), test_b9_text_count_ignores_layout(), test_b9_text_item_ignores_layout(), test_butlast_removes_last_line() (+67 more)
...
### Community 80 - "test_scaffold_setUp_with_device_and_hardware"
Cohesion: 0.18
Nodes (9): properties_init(), LogoHardware, LogoHardwareOps, logo_hardware_init(), setUp(), setUp(), setUp(), test_scaffold_setUp_with_device_and_hardware() (+1 more)
...
Cohesion: 0.08
Nodes (98): CatalogContext, CatalogEntry, httpd_respondfile(), httpd_savebody(), path_is_safe(), Evaluator, Result, Value (+90 more)
...
Cohesion: 0.29
Nodes (14): Evaluator, Result, Value, count_bracket_balance(), prim_edall(), prim_edit(), prim_editfile(), prim_edn() (+6 more)

### Community 90 - "mem_atom_cstr"
Cohesion: 0.12
Nodes (38): mem_atom_cstr(), Evaluator, Result, Value, get_bool_arg(), prim_and(), prim_not(), prim_or() (+30 more)
...
### Community 95 - "eval.c"
Cohesion: 0.25
Nodes (26): EvalOpKind, Evaluator, FrameStack, Node, Result, UserProcedure, Value, eval_call_primitive() (+18 more)
...
Cohesion: 0.12
Nodes (25): frame_stack_restore(), frame_stack_snapshot(), UserProcedure, find_procedure_index(), find_procedure_index_n(), invalidate_name_bindings(), proc_bury(), proc_bury_all() (+17 more)

### Community 104 - "primitives_debug_control.c"
Cohesion: 0.31
...
Cohesion: 0.02
Nodes (126): Value, value_is_true(), mem_word_ptr(), test_make_small_number_in_object_is_valid_json(), test_make_small_number_is_valid_json(), bind_long_blob_word(), exhaust_atom_table(), exhaust_node_pool() (+118 more)
...
Cohesion: 0.12
Nodes (92): read_predicate_bool(), number_to_word(), mem_gc_roots_pop(), mem_gc_roots_push(), mem_list_append(), mem_word(), mem_word_len(), Evaluator (+84 more)
...
### Community 126 - "token_source.c"
Cohesion: 0.31
Nodes (10): Token, TokenType, compute_word_class(), is_delimiter_token(), is_number_word(), node_iter_next(), token_from_class(), token_source_gc_mark() (+2 more)
...
Cohesion: 0.13
Nodes (30): atom_memo_bind_index(), atom_memo_bind_kind(), atom_memo_class(), atom_memo_set_binding(), atom_memo_set_class(), eval_at_end(), apply_binary_op(), Evaluator (+22 more)
...
### Community 138 - "logo_io_init"
Cohesion: 0.11
Nodes (27): LogoConsole, LogoHardware, LogoStorage, logo_io_check_write_error(), logo_io_cleanup(), logo_io_dribble_input(), logo_io_flush(), logo_io_init() (+19 more)

### Community 139 - "test_primitives_debug_control.c"
Cohesion: 0.07
...
Cohesion: 0.24
Nodes (24): Node, Value, format_body_element(), format_body_element_multiline(), format_body_indent(), format_buffer_pos(), format_list_contents(), format_list_with_newlines() (+16 more)

### Community 142 - "logo_storage_init"
Cohesion: 0.18
...
### Community 147 - "mock_device_clear_editor"
Cohesion: 0.16
...
### Community 150 - "proc_find"
Cohesion: 0.16
Nodes (25): UserProcedure, format_procedure_definition(), format_procedure_title(), format_procedure_to_buffer(), proc_erase(), proc_find(), test_format_procedure_definition_bracket_single_token_last_line(), test_format_procedure_definition_bracket_three_lines() (+17 more)
...
Cohesion: 0.08
Nodes (86): Binding, FrameHeader, FrameStack, UserProcedure, Value, word_offset_t, calc_frame_size(), frame_add_local() (+78 more)

### Community 159 - "screen_set_mode"
Cohesion: 0.09
...
Cohesion: 0.19
Nodes (27): proc_exists(), LogoEditorResult, mock_device_set_editor_content(), mock_device_set_editor_result(), mock_editor_edit(), mock_fs_create_file(), mock_fs_get_content(), setUp_with_storage() (+19 more)
...
### Community 164 - "Modifying Procedures Under Program Control"
Cohesion: 0.25
...
### Community 177 - "repl_evaluate_line"
Cohesion: 0.22
Nodes (13): Result, name_distance(), repl_evaluate_line(), repl_line_is_end(), repl_next_bracket_depth(), repl_restore_refresh(), repl_suggest_name(), suggest_similar_name() (+5 more)

### Community 178 - "test_pop_scope"
Cohesion: 0.10
Nodes (36): var_is_shadowed_by_local(), var_set_local(), test_dots_variable(), test_global_variable(), test_local_declaration(), test_local_variable_not_visible_after_scope(), test_local_variable_shadowing(), test_local_with_list() (+28 more)

### Community 180 - "repl_proc_def_append"
Cohesion: 0.25
...
### Community 196 - "logo_console_init"
Cohesion: 0.39
...
Cohesion: 0.15
Nodes (19): frame_pop(), frame_stack_available_bytes(), frame_stack_depth(), frame_stack_init(), frame_stack_is_empty(), frame_stack_reset(), setUp(), test_pop_all_frames() (+11 more)
...
### Community 200 - "demons_maybe_poll"
Cohesion: 0.47
Nodes (6): demons_maybe_poll(), demons_running(), httpd_maybe_poll(), logo_io_has_ticks_ms(), logo_io_ticks_ms(), console_idle_poll()

### Community 201 - "parse_bracket_contents"
Cohesion: 0.53
Nodes (6): append_to_list(), Lexer, Node, Token, parse_bracket_contents(), token_to_atom()

### Community 202 - "repl_extract_proc_name"
Cohesion: 0.33
...
### Community 203 - "Time Management"
Cohesion: 0.33
Nodes (6): date, setdate, settime, ticks, time, Time Management

### Community 204 - "repl_count_bracket_balance"
Cohesion: 0.40
...
### Community 205 - "repl_line_starts_with_to"
Cohesion: 0.40
...
### Community 206 - "logo_io_console_write"
Cohesion: 0.50
Nodes (4): SyntaxCategory, highlight_write_span(), logo_io_console_write(), test_console_write()
...
- **Why does `run_string()` connect `run_string` to `mem_is_nil`, `reset_output`, `eval_string`, `eval_primary`, `result_none`, `test_trails.c`, `test_primitives_debug_control.c`, `test_primitives_files_directory.c`, `io.c`, `lexer_init`, `mock_device_clear_editor`, `test_variables.c`, `proc_find`, `test_eval.c`, `test_scaffold_setUp`, `test_primitives_conditionals.c`, `test_primitives_json.c`, `mem_atom`, `test_scaffold.h`, `mock_device_set_editor_result`, `test_primitives_files.c`, `mock_device_get_state`, `test_time.c`, `test_bench_throughput.c`, `set_mock_input`, `test_primitives_tilemap.c`, `test_primitives_hardware.c`, `test_pop_scope`, `test_sound.c`, `test_primitives_files_load_save.c`, `op_stack_push`, `demons_poll`, `define_proc`, `mem_set_cdr`, `proc_define_from_text`, `test_scaffold_setUp_with_device_and_hardware`, `eval.c`, `test_galaxian.c`, `mem_word_ptr`, `test_primitives_outside_world.c`, `value_to_string`, `test_primitives_editor.c`, `test_scaffold.c`, `test_checkrun.c`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `eval_string()` connect `eval_string` to `test_value.c`, `mem_is_nil`, `reset_output`, `eval_primary`, `test_trails.c`, `test_primitives_files_directory.c`, `lexer_init`, `test_httpd.c`, `test_eval.c`, `proc_find`, `test_primitives_http.c`, `test_primitives_conditionals.c`, `test_primitives_json.c`, `mem_atom`, `test_scaffold.h`, `test_primitives_files.c`, `test_primitives_wifi.c`, `mock_device_get_state`, `test_time.c`, `test_primitives_tilemap.c`, `test_primitives_hardware.c`, `test_pop_scope`, `test_sound.c`, `test_primitives_network.c`, `op_stack_push`, `test_mock_fs.h`, `demons_poll`, `define_proc`, `mem_set_cdr`, `proc_define_from_text`, `mem_atom_cstr`, `eval.c`, `test_galaxian.c`, `mem_word_ptr`, `test_primitives_outside_world.c`, `value_to_string`, `test_scaffold.c`, `test_checkrun.c`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `result_none()` connect `result_none` to `run_string`, `test_tilemap.c`, `primitives_control_flow.c`, `test_value.c`, `eval_primary`, `primitives_turtle.c`, `io.c`, `primitives_sound.c`, `primitives_text.c`, `primitives_conditionals.c`, `value_number`, `primitives_httpd.c`, `set_mock_input`, `repl_evaluate_line`, `httpd.c`, `op_stack_push`, `demons_poll`, `step_proc_call`, `primitives.h`, `demons_maybe_poll`, `prim_local`, `result_error_arg`, `run_editor_and_process`, `mem_atom_cstr`, `eval.c`, `primitives_debug_control.c`, `value_to_string`?**
