...
## Corpus Check
- 277 files · ~440,544 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6697 nodes · 21392 edges · 199 communities (188 shown, 11 thin omitted)
...
Cohesion: 0.02
Nodes (208): MockLine, mock_device_clear_graphics(), mock_device_get_line(), mock_device_get_output(), mock_device_has_line_from_to(), mock_device_line_count(), mock_device_paint_canvas(), mock_device_set_canvas_point() (+200 more)
...
Cohesion: 0.03
Nodes (141): format_number(), json_format_number(), Node, Value, result_error_in(), result_get_value(), result_is_ok(), result_is_returnable() (+133 more)

### Community 4 - "mem_is_nil"
Cohesion: 0.05
Nodes (131): mem_car(), mem_cdr(), mem_is_nil(), mem_is_word(), Evaluator, Result, Value, prim_step() (+123 more)
...
Cohesion: 0.02
Nodes (127): mem_word_ptr(), test_filter_with_word(), test_find_basic(), test_find_first_element(), bind_long_blob_word(), exhaust_atom_table(), exhaust_node_pool(), test_ascii() (+119 more)

### Community 7 - "result_none"
Cohesion: 0.11
Nodes (97): Evaluator, Result, Value, get_screen_ops(), get_text_ops(), prim_cleartext(), prim_cursor(), prim_fullscreen() (+89 more)

### Community 8 - "value_to_string"
Cohesion: 0.20
Nodes (52): number_to_word(), mem_list_append(), mem_word_len(), Evaluator, Node, Result, Value, find_element_in_list() (+44 more)

### Community 9 - "mem_atom"
Cohesion: 0.04
Nodes (84): httpd_buf_init(), blob_alloc(), mem_atom_cstr(), mem_atom_unescape(), mem_blob(), mem_blob_free_bytes(), mem_blob_used(), mem_free_atoms() (+76 more)
...
Cohesion: 0.03
Nodes (97): frame_stack_depth(), proc_define_from_text(), FrameStack, proc_get_frame_stack(), test_deep_nested_proc_in_repeat(), test_many_iterations_proc_in_repeat_within_procedure(), test_proc_call_followed_by_commands_in_repeat(), test_proc_call_in_if_within_procedure() (+89 more)

### Community 12 - "error_format"
Cohesion: 0.03
Nodes (81): append_caller_suffix(), Result, error_clear_caught(), error_format(), error_message(), error_set_caught(), test_error_format_cant_from_editor(), test_error_format_cant_open_network() (+73 more)
...
Cohesion: 0.05
Nodes (132): Node, demons_set(), mem_atom(), mem_cons(), Lexer, Node, Token, TokenType (+124 more)
...
Cohesion: 0.04
Nodes (62): logo_io_cleanup(), logo_io_parse_network_address(), logo_io_set_reader(), logo_io_set_writer(), logo_io_start_dribble(), logo_io_stop_dribble(), LogoDirCallback, LogoEntryType (+54 more)
...
### Community 25 - "io.c"
Cohesion: 0.08
Nodes (68): demons_maybe_poll(), eval_instruction(), httpd_maybe_poll(), prim_sync(), LogoIO, LogoStream, SyntaxCategory, create_network_stream() (+60 more)

### Community 26 - "test_primitives_http.c"
Cohesion: 0.06
Nodes (66): mock_device_get_last_tcp_ip(), mock_device_get_last_tcp_port(), mock_device_get_last_tls_host(), mock_device_get_tcp_request(), mock_device_set_tcp_connect_result(), mock_device_set_tcp_response(), Result, get_body_of_size() (+58 more)
...
Cohesion: 0.03
Nodes (111): LogoConsole, LogoStreamOps, logo_console_has_editor(), logo_console_has_screen_modes(), logo_console_has_text(), logo_console_has_turtle(), logo_console_init(), MockCommand (+103 more)
...
Cohesion: 0.10
Nodes (33): mem_set_cdr(), append_to_list(), Evaluator, Lexer, Node, Result, Token, Value (+25 more)
...
Cohesion: 0.05
Nodes (62): logo_mem_init(), LogoIO, primitives_control_reset_test_state(), primitives_set_io(), proc_clear_tail_call(), proc_reset_execution_state(), procedures_init(), properties_init() (+54 more)

### Community 45 - "set_mock_input"
Cohesion: 0.10
Nodes (54): LogoIO, repl_cleanup(), repl_count_bracket_balance(), repl_extract_proc_name(), repl_init(), repl_line_is_end(), repl_line_starts_with_to(), repl_run() (+46 more)
...
Cohesion: 0.10
Nodes (25): Value, demons_clear(), demons_freeze(), demons_print(), demons_reset(), demons_running(), demons_thaw(), value_is_true() (+17 more)
...
### Community 71 - "main"
Cohesion: 0.07
Nodes (32): blob_reset(), logo_mem_set_aux_region(), lfs_t, LogoStorage, logo_lfs_storage_init(), main(), psram_verify(), m1_capture() (+24 more)
...
Cohesion: 0.20
Nodes (36): Evaluator, Result, Value, prim_allopen(), prim_close(), prim_closeall(), prim_dribble(), prim_filelen() (+28 more)
...
Cohesion: 0.42
Nodes (17): mem_gc_roots_pop(), mem_gc_roots_push(), Evaluator, Result, Value, invoke_proc_spec(), parse_proc_spec(), prim_apply() (+9 more)
...
Cohesion: 0.20
Nodes (20): LogoIO, Node, UserProcedure, help_list_add(), help_list_flush(), prim_help(), prim_poall(), prim_pons() (+12 more)
...
Cohesion: 0.57
Nodes (6): Evaluator, Result, Value, prim_network_ping(), prim_network_resolve(), prim_ntp()
...
Cohesion: 0.08
Nodes (49): BlobDesc, demons_gc_mark_all(), Value, mark_value(), op_stack_gc_mark(), alloc_cell(), atom_entry_is_free(), atom_entry_next() (+41 more)
...
- **Why does `run_string()` connect `run_string` to `eval_string`, `test_value.c`, `mem_is_nil`, `reset_output`, `mem_word_ptr`, `result_none`, `proc_define_from_text`, `error_format`, `format_buffer_init`, `lexer_init`, `test_primitives_editor.c`, `JSON`, `test_variables.c`, `io.c`, `mock_device_get_state`, `test_primitives_json.c`, `test_primitives_control_flow.c`, `test_scaffold.h`, `memory.c`, `bd_prog`, `test_primitives_files.c`, `test_time.c`, `test_scaffold_setUp`, `set_mock_input`, `test_primitives_outside_world.c`, `test_mock_device.c`, `demons_poll`, `prim_cleardemons`, `prim_savel`, `eval.c`, `main`, `test_primitives_control_flow.c`, `test_scaffold.c`, `test_galaxian.c`, `logo_io_init`, `eval_primary`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Why does `eval_string()` connect `eval_string` to `test_value.c`, `mem_is_nil`, `reset_output`, `mem_word_ptr`, `value_to_string`, `logo_io_set_writer`, `mem_atom`, `proc_define_from_text`, `error_format`, `format_buffer_init`, `lexer_init`, `JSON`, `test_variables.c`, `test_token_source.c`, `test_httpd.c`, `test_primitives_http.c`, `mock_device_get_state`, `test_primitives_json.c`, `test_primitives_control_flow.c`, `test_scaffold.h`, `memory.c`, `bd_prog`, `test_primitives_files.c`, `test_primitives_wifi.c`, `test_time.c`, `test_primitives_outside_world.c`, `test_mock_device.c`, `test_primitives_network.c`, `test_mock_fs.h`, `demons_poll`, `prim_cleardemons`, `prim_savel`, `eval.c`, `main`, `test_primitives_control_flow.c`, `test_scaffold.c`, `test_galaxian.c`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `mem_word_ptr()` connect `mem_word_ptr` to `run_string`, `eval_string`, `prim_pause`, `mem_is_nil`, `test_value.c`, `reset_output`, `result_none`, `value_to_string`, `mem_atom`, `logo_io_set_writer`, `proc_define_from_text`, `error_format`, `format_buffer_init`, `test_primitives_editor.c`, `test_variables.c`, `test_token_source.c`, `test_httpd.c`, `primitives_debug_control.c`, `test_primitives_http.c`, `test_primitives_json.c`, `test_scaffold.h`, `Time Management`, `test_primitives_conditionals.c`, `memory.c`, `test_primitives_files.c`, `test_primitives_wifi.c`, `mem_atom_cstr`, `test_time.c`, `set_mock_input`, `test_primitives_outside_world.c`, `primitives.h`, `httpd.c`, `procedures.c`, `primitives_workspace.c`, `test_mock_device.c`, `test_primitives_network.c`, `test_primitives_files_directory.c`, `primitives_json.c`, `prim_cleardemons`, `prim_savel`, `primitives_get_io`, `test_primitives_control_flow.c`, `eval_push_if`, `mklfsimg_lib.c`, `southbridge.c`, `primitives_control_flow.c`, `primitives_outside_world.c`, `eval_primary`?**
