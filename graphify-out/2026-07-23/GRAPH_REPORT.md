...
## Corpus Check
- 277 files · ~440,187 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6670 nodes · 21286 edges · 195 communities (184 shown, 11 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 9616 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0f24fcf5`
...
Cohesion: 0.02
Nodes (195): MockLine, mock_device_clear_graphics(), mock_device_get_line(), mock_device_get_output(), mock_device_has_line_from_to(), mock_device_line_count(), mock_device_verify_palette(), test_addressing_primitives_registered() (+187 more)
...
Cohesion: 0.02
Nodes (164): Node, demons_print(), demons_set(), format_number(), prim_when(), parse_turtle_set(), prim_putsh(), Node (+156 more)

### Community 4 - "mem_is_nil"
Cohesion: 0.05
Nodes (124): index_to_node(), mem_car(), mem_cdr(), mem_is_nil(), Lexer, parse_list_body(), parse_list_from_string(), prim_for() (+116 more)

### Community 5 - "reset_output"
Cohesion: 0.02
Nodes (159): proc_is_stepped(), proc_is_traced(), test_rerandom_affects_pick_and_shuffle(), test_comment_in_procedure(), test_comment_inline(), test_comment_with_list(), test_comment_with_word(), test_do_until_basic() (+151 more)

### Community 6 - "mem_word_ptr"
Cohesion: 0.02
Nodes (171): mem_word_ptr(), mock_device_set_wifi_mac(), test_make_small_number_in_object_is_valid_json(), test_make_small_number_is_valid_json(), test_keyp_no_input_returns_false(), test_keyp_with_input_returns_true(), test_pr_abbreviation(), test_print_empty_list() (+163 more)
...
Cohesion: 0.14
Nodes (75): number_to_word(), mem_list_append(), mem_word(), mem_word_len(), prim_form(), prim_http_element(), Evaluator, Result (+67 more)

### Community 9 - "mem_atom"
Cohesion: 0.04
Nodes (137): BlobDesc, alloc_cell(), atom_entry_next(), atom_entry_set_next(), atom_hash(), blob_alloc(), blob_desc(), blob_free() (+129 more)
...
Cohesion: 0.03
Nodes (98): proc_define_from_text(), test_deep_nested_proc_in_repeat(), test_many_iterations_proc_in_repeat_within_procedure(), test_proc_call_followed_by_commands_in_repeat(), test_proc_call_in_if_within_procedure(), test_proc_call_in_repeat_within_procedure(), test_proc_expr_in_run_within_procedure(), test_co_at_toplevel() (+90 more)
...
Cohesion: 0.05
Nodes (104): Node, UserProcedure, Value, format_body_element(), format_body_element_multiline(), format_buffer_init(), format_buffer_output(), format_buffer_pos() (+96 more)
...
Cohesion: 0.06
Nodes (75): Value, find_global(), var_bury(), var_bury_all(), var_declare_local(), var_erase(), var_erase_all(), var_erase_all_globals() (+67 more)
...
Cohesion: 0.09
Nodes (53): httpd_request_pending(), mock_httpd_conn_response(), mock_httpd_queue_connection(), mock_httpd_queue_connection_ex(), mock_httpd_queue_connection_stalled(), mock_httpd_set_read_hook(), pump(), resp_str() (+45 more)

### Community 23 - "test_io.c"
Cohesion: 0.04
Nodes (55): logo_io_flush(), logo_io_is_dribbling(), logo_io_parse_network_address(), logo_io_set_writer(), logo_io_start_dribble(), logo_io_stop_dribble(), LogoDirCallback, LogoEntryType (+47 more)
...
Cohesion: 0.03
Nodes (10): mock_device_add_wifi_scan_result(), mock_device_get_tcp_request_len(), mock_device_set_input(), mock_device_set_snap_result(), mock_device_set_tcp_close_after(), mock_device_set_tcp_read_chunk(), mock_device_set_tcp_write_chunk(), mock_device_was_restore_palette_called() (+2 more)
...
Cohesion: 0.02
Nodes (78): tearDown(), tearDown(), tearDown(), tearDown(), tearDown(), setUp(), tearDown(), tearDown() (+70 more)
...
Cohesion: 0.20
Nodes (23): assert_word(), LogoDirCallback, fs_list_children(), handle(), pump(), resp_str(), seed_tree(), status_is() (+15 more)
...
Cohesion: 0.02
Nodes (86): mock_fs_create_dir(), test_cat_lists_files(), test_cat_runs_without_error(), test_cat_with_invalid_input_error(), test_catalog_long_format_marks_directories(), test_catalog_long_format_shows_size(), test_catalog_runs_without_error(), test_catalog_with_absolute_pathname() (+78 more)
...
Cohesion: 0.05
Nodes (55): mock_device_clear_wifi_scan_results(), mock_device_get_hostname(), mock_device_set_wifi_connect_result(), mock_device_set_wifi_connected(), mock_device_set_wifi_ip(), mock_device_set_wifi_scan_result(), mock_device_set_wifi_ssid(), mock_device_set_wifi_start_result() (+47 more)
...
Cohesion: 0.04
Nodes (86): blob_reset(), logo_mem_init(), LogoIO, primitives_control_reset_test_state(), primitives_set_io(), procedures_init(), properties_init(), variables_init() (+78 more)
...
Cohesion: 0.10
Nodes (23): Value, demons_clear(), demons_freeze(), demons_reset(), demons_thaw(), value_is_true(), count_bracket_balance(), editor_pick_buffer() (+15 more)
...
Cohesion: 0.21
Nodes (20): LogoStream, screen_gfx_load(), screen_gfx_save(), LogoStream, logo_stream_can_read(), logo_stream_clear_write_error(), logo_stream_copy(), logo_stream_flush() (+12 more)
...
Cohesion: 0.13
Nodes (19): httpd_listening(), mock_httpd_is_listening(), mock_httpd_listen_port(), drain(), tearDown(), test_accept_returns_connection_and_remote_ip(), test_can_read_reflects_available_bytes(), test_dribbled_read_delivers_in_chunks() (+11 more)
...
Cohesion: 0.13
Nodes (31): Result, demons_frozen(), demons_maybe_poll(), demons_poll(), logo_io_ticks_ms(), MockTurtleState, mock_device_clear_output(), mock_device_get_turtle() (+23 more)
...
Cohesion: 0.10
Nodes (57): Lexer, eval_init(), EvalOp, op_stack_alloc_prim_args(), op_stack_depth(), op_stack_get_prim_args(), op_stack_init(), op_stack_is_empty() (+49 more)
...
### Community 83 - "eval.c"
Cohesion: 0.12
Nodes (41): mem_atom_cstr(), Evaluator, Result, Value, prim_catch(), prim_error(), prim_throw(), prim_toplevel() (+33 more)
...
Cohesion: 0.12
Nodes (17): Node, Result, Value, result_get_error_code(), result_get_goto_label(), result_get_pause_proc(), result_get_throw_tag(), result_get_value() (+9 more)
...
Cohesion: 0.15
Nodes (15): LogoStreamOps, logo_stream_init(), logo_stream_write_line(), LogoStreamType, LogoStream, mock_write(), setUp(), test_has_write_error_with_null_stream() (+7 more)
...
Cohesion: 0.09
Nodes (37): mock_device_get_gfx_load_call_count(), mock_device_get_gfx_save_call_count(), mock_device_get_last_gfx_load_filename(), mock_device_get_last_gfx_save_filename(), mock_device_set_gfx_load_result(), mock_device_set_gfx_save_result(), setUp_with_turtle(), tearDown_with_turtle() (+29 more)
...
Cohesion: 0.31
Nodes (10): proc_reset_execution_state(), Result, name_distance(), repl_evaluate_line(), repl_next_bracket_depth(), repl_restore_refresh(), repl_suggest_name(), suggest_similar_name() (+2 more)
...
Cohesion: 0.49
Nodes (16): mem_is_word(), Evaluator, Result, Value, invoke_proc_spec(), parse_proc_spec(), prim_apply(), prim_crossmap() (+8 more)
...
Cohesion: 0.11
Nodes (27): demons_gc_mark_all(), Value, mark_value(), op_stack_gc_mark(), mem_gc_mark(), prim_recycle(), find_procedure_index(), proc_bury() (+19 more)
...
Cohesion: 0.18
Nodes (12): repl_line_is_end(), repl_line_starts_with_to(), load_fileserver(), load_galaxian(), setUp(), test_repl_line_is_end_basic(), test_repl_line_is_end_false_cases(), test_repl_line_is_end_with_whitespace() (+4 more)

## Knowledge Gaps
- **633 isolated node(s):** `dist.sh script`, `flash.sh script`, `name`, `displayName`, `description` (+628 more)
...
- **Why does `run_string()` connect `run_string` to `eval_string`, `mem_is_nil`, `reset_output`, `mem_word_ptr`, `result_none`, `value_to_string`, `mem_atom`, `proc_define_from_text`, `error_format`, `format_buffer_init`, `lexer_init`, `test_primitives_editor.c`, `test_variables.c`, `io.c`, `mock_device_get_state`, `test_primitives_json.c`, `test_primitives_control_flow.c`, `test_scaffold.h`, `bd_prog`, `test_primitives_files.c`, `logo_stream_init`, `mem_atom_cstr`, `test_time.c`, `test_scaffold_setUp`, `set_mock_input`, `test_primitives_outside_world.c`, `test_mock_device.c`, `demons_poll`, `prim_cleardemons`, `op_stack_push`, `prim_savel`, `repl_count_bracket_balance`, `test_scaffold.c`, `test_galaxian.c`, `primitives_control_flow.c`, `logo_io_init`?**
  _High betweenness centrality (0.145) - this node is a cross-community bridge._
- **Why does `eval_string()` connect `eval_string` to `mem_is_nil`, `reset_output`, `mem_word_ptr`, `value_to_string`, `mem_atom`, `proc_define_from_text`, `error_format`, `format_buffer_init`, `lexer_init`, `test_variables.c`, `test_httpd.c`, `test_primitives_http.c`, `mock_device_get_state`, `test_primitives_json.c`, `test_primitives_control_flow.c`, `test_scaffold.h`, `memory.c`, `bd_prog`, `test_primitives_files.c`, `test_primitives_wifi.c`, `mem_atom_cstr`, `test_time.c`, `test_primitives_outside_world.c`, `test_mock_device.c`, `test_primitives_network.c`, `test_primitives_files_directory.c`, `op_stack_push`, `prim_cleardemons`, `prim_savel`, `eval.c`, `test_scaffold.c`, `test_galaxian.c`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `result_none()` connect `result_none` to `run_string`, `test_value.c`, `prim_pause`, `mem_is_nil`, `value_to_string`, `test_primitives_outside_world.c`, `LogoStream`, `io.c`, `primitives_debug_control.c`, `prim_local`, `Time Management`, `bd_prog`, `on_sd_card_detect`, `set_mock_input`, `primitives.h`, `httpd.c`, `procedures.c`, `primitives_workspace.c`, `test_scaffold_setUp_with_device_and_hardware`, `demons_poll`, `prim_cleardemons`, `op_stack_push`, `value_number`, `primitives_get_io`, `eval.c`, `eval_push_if`, `mklfsimg_lib.c`, `southbridge.c`, `primitives_outside_world.c`, `eval_primary`, `procedures.c`?**
...
- **Are the 886 inferred relationships involving `eval_string()` (e.g. with `test_deep_recursion_100_levels()` and `test_deep_recursion_addupto()`) actually correct?**
  _`eval_string()` has 886 INFERRED edges - model-reasoned connections that need verification._
