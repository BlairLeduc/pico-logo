...
## Corpus Check
- 279 files · ~441,717 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6722 nodes · 21473 edges · 197 communities (186 shown, 11 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 9694 edges (avg confidence: 0.8)
...
Cohesion: 0.02
Nodes (176): Node, demons_set(), format_number(), prim_battery_level(), json_format_number(), Node, Result, Value (+168 more)

### Community 4 - "mem_is_nil"
Cohesion: 0.04
Nodes (122): mem_car(), mem_cdr(), mem_is_list(), mem_is_nil(), Lexer, parse_list_body(), parse_list_from_string(), Evaluator (+114 more)
...
Cohesion: 0.03
Nodes (124): mem_is_blob(), mem_word_ptr(), test_make_small_number_in_object_is_valid_json(), test_make_small_number_is_valid_json(), bind_long_blob_word(), exhaust_atom_table(), exhaust_node_pool(), test_ascii() (+116 more)
...
Cohesion: 0.10
Nodes (89): demons_print(), number_to_word(), mem_list_append(), mem_word(), prim_form(), prim_wait(), prim_free(), Evaluator (+81 more)

### Community 9 - "mem_atom"
Cohesion: 0.04
Nodes (176): mem_atom(), mem_cons(), mem_free_atoms(), mem_free_nodes(), mem_gc(), mem_set_car(), mem_total_atoms(), mem_word_eq() (+168 more)
...
Cohesion: 0.07
Nodes (85): value_number(), Value, find_global(), var_bury(), var_bury_all(), var_declare_local(), var_erase(), var_erase_all() (+77 more)
...
Cohesion: 0.08
Nodes (67): eval_instruction(), LogoIO, LogoStream, SyntaxCategory, create_network_stream(), highlight_write_span(), logo_io_check_freeze_request(), logo_io_check_pause_request() (+59 more)
...
### Community 25 - "io.c"
Cohesion: 0.09
Nodes (36): frame_binding_count(), frame_pop(), frame_stack_available_bytes(), frame_stack_depth(), frame_stack_is_empty(), frame_stack_used_bytes(), FrameStack, proc_get_frame_stack() (+28 more)
...
Cohesion: 0.04
Nodes (44): tearDown(), tearDown(), tearDown(), tearDown(), assert_fullscreen_canvas_hud(), load_game(), setUp(), tearDown() (+36 more)
...
Cohesion: 0.06
Nodes (48): blob_reset(), logo_mem_init(), primitives_control_reset_test_state(), primitives_set_io(), properties_init(), variables_init(), LogoHardware, LogoHardwareOps (+40 more)

### Community 45 - "set_mock_input"
Cohesion: 0.14
Nodes (44): prim_pause(), LogoIO, repl_cleanup(), repl_extract_proc_name(), repl_init(), repl_line_is_end(), repl_run(), ReplFlags (+36 more)
...
Cohesion: 0.35
Nodes (16): Evaluator, Result, Value, flush_writer(), prim_keyp(), prim_print(), prim_readchar(), prim_readlist() (+8 more)
...
Cohesion: 0.25
Nodes (30): LogoIO, Evaluator, Result, Value, prim_allopen(), prim_close(), prim_closeall(), prim_dribble() (+22 more)
...
Cohesion: 0.19
Nodes (33): Evaluator, Node, Result, Value, enter_array(), enter_object(), extract_value(), hex_val() (+25 more)
...
Cohesion: 0.08
Nodes (28): proc_clear_tail_call(), proc_reset_execution_state(), procedures_init(), lfs_t, LogoStorage, logo_lfs_storage_init(), main(), psram_verify() (+20 more)
...
Cohesion: 0.35
Nodes (17): httpd_savebody(), Evaluator, Result, Value, prim_load(), prim_loadpic(), prim_pofile(), prim_save() (+9 more)

### Community 111 - "logo_storage_init"
Cohesion: 0.14
Nodes (26): mem_atom_cstr(), Evaluator, Result, Value, prim_catch(), prim_error(), prim_throw(), prim_toplevel() (+18 more)
...
Cohesion: 0.04
Nodes (55): logo_io_is_dribbling(), logo_io_parse_network_address(), logo_io_set_writer(), logo_io_start_dribble(), logo_io_stop_dribble(), LogoDirCallback, LogoEntryType, LogoStream (+47 more)
...
Cohesion: 0.08
Nodes (55): demons_gc_mark_all(), op_stack_gc_mark(), alloc_cell(), atom_chain_next(), atom_clear_marks(), atom_entry_is_free(), atom_entry_next(), atom_entry_set_next() (+47 more)
...
- **Why does `run_string()` connect `run_string` to `eval_string`, `test_value.c`, `mem_is_nil`, `reset_output`, `mem_word_ptr`, `result_none`, `value_to_string`, `logo_io_set_writer`, `proc_define_from_text`, `error_format`, `format_buffer_init`, `lexer_init`, `test_primitives_editor.c`, `test_variables.c`, `test_token_source.c`, `test_io.c`, `io.c`, `mock_device_get_state`, `test_primitives_json.c`, `test_primitives_control_flow.c`, `test_scaffold.h`, `List Processing`, `test_primitives_files.c`, `test_primitives_hardware.c`, `test_time.c`, `test_scaffold_setUp`, `set_mock_input`, `test_primitives_outside_world.c`, `test_mock_device.c`, `demons_poll`, `eval.c`, `test_primitives_control_flow.c`, `test_scaffold.c`, `test_galaxian.c`, `primitives_control_flow.c`, `logo_io_init`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `eval_string()` connect `eval_string` to `test_value.c`, `mem_is_nil`, `reset_output`, `mem_word_ptr`, `value_to_string`, `mem_atom`, `logo_io_set_writer`, `proc_define_from_text`, `error_format`, `format_buffer_init`, `lexer_init`, `test_variables.c`, `test_token_source.c`, `test_httpd.c`, `io.c`, `test_primitives_http.c`, `mock_device_get_state`, `test_primitives_json.c`, `test_primitives_control_flow.c`, `List Processing`, `test_primitives_files.c`, `test_primitives_wifi.c`, `test_primitives_hardware.c`, `test_time.c`, `test_primitives_outside_world.c`, `primitives_workspace.c`, `test_mock_device.c`, `test_primitives_network.c`, `test_mock_fs.h`, `demons_poll`, `eval.c`, `test_primitives_control_flow.c`, `test_scaffold.c`, `test_galaxian.c`, `primitives_control_flow.c`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `mem_word_ptr()` connect `mem_word_ptr` to `run_string`, `eval_string`, `test_value.c`, `mem_is_nil`, `reset_output`, `result_none`, `value_to_string`, `mem_atom`, `primitives_properties.c`, `logo_io_set_writer`, `proc_define_from_text`, `error_format`, `format_buffer_init`, `test_primitives_editor.c`, `test_variables.c`, `test_token_source.c`, `repl_extract_proc_name`, `test_httpd.c`, `test_primitives_http.c`, `List Processing`, `memory.c`, `test_primitives_files.c`, `test_primitives_wifi.c`, `test_primitives_hardware.c`, `test_time.c`, `set_mock_input`, `test_primitives_outside_world.c`, `primitives.h`, `httpd.c`, `procedures.c`, `primitives_workspace.c`, `test_mock_device.c`, `test_primitives_network.c`, `test_primitives_files_directory.c`, `primitives_json.c`, `primitives_get_io`, `primitives_httpd.c`, `repl_evaluate_line`, `mklfsimg_lib.c`, `logo_storage_init`, `southbridge.c`, `primitives_control_flow.c`, `primitives_outside_world.c`?**
