...
//
//  Defines the LCD interface for PicoCalc device.
//
...
#define COLUMNS (WIDTH / GLYPH_WIDTH) // number of text columns that fit on the LCD
#define MAX_COLUMN (COLUMNS - 1)      // maximum column index (0-based)
