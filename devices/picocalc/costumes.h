...
//  colour. Sizes range from 8x8 to 32x32, any rectangle. Slots 1-25 hold
...
#define COSTUME_SLOTS (LOGO_SHAPE_MAX_SLOT + 1)  // slots 1-25 usable; 0 is the vector turtle
#define COSTUME_POOL_SIZE 8192  // SRAM tier (design doc §10)

// Reset the pool: all slots empty
void costumes_clear(void);

// Store a colour costume in a slot (1-25), replacing any previous one.
